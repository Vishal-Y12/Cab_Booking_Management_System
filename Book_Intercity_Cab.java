...
public class Book_Intercity_Cab extends JFrame implements ActionListener {
    ...
    Book_Intercity_Cab(){
        ...
        ImageIcon ic= new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons/intercity1.png"));
        Image img=ic.getImage().getScaledInstance(550, 500, Image.SCALE_DEFAULT);
          ...
          ch1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                try
                {
                        ...
                        String q1="select destination from intercity_driver where source ='"+source+"'";
                        ResultSet rest1=obj.stm.executeQuery(q1);
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==bt1){
           ...
           try{
               ...
               String q1="insert into intercitycab values('"+bid+"', '"+username+"','"+name+"', '"+dname+"' ,'"+source+"',  '"+destination+"','"+type+"','"+car+"', '"+price+"')";

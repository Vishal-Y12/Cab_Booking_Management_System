...
public class Update_Customer extends JFrame implements ActionListener  {
    ...
    Update_Customer()
    {
        ...
        ImageIcon ic= new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons/update5.png"));
        Image img=ic.getImage().getScaledInstance(299, 500, Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==bt1)
        {
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "please!, Fill all detaaails carefully");

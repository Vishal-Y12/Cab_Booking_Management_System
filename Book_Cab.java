...
public class Book_Cab extends JFrame implements ActionListener{
    ...
    Book_Cab(){
        ...
        ImageIcon ic= new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons/bookcab.png"));
        Image img=ic.getImage().getScaledInstance(680, 400, Image.SCALE_DEFAULT);
